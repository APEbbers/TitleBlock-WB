...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox.setGeometry(QRect(5, 225, 421, 101))
        font = QFont()
        font.setBold(True)
        ...
        self.groupBox_2.setGeometry(QRect(5, 140, 421, 76))
        ...
        self.label.setGeometry(QRect(5, 325, 401, 16))
        font2 = QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.DrawingNumber.setPlaceholderText(QCoreApplication.translate("Form", u"Enter fied name...", None))
